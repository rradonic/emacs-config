...
(custom-set-faces
 ...
 `(ediff-current-diff-A ((t (:background "#668b8b" :foreground ,zenburn-fg))))
 `(ediff-current-diff-Ancestor ((t (:background "#668b8b" :foreground ,zenburn-fg))))
 `(ediff-current-diff-B ((t (:background "#668b8b" :foreground ,zenburn-fg))))
 `(ediff-current-diff-C ((t (:background "#668b8b" :foreground ,zenburn-fg))))
 ...
 `(ediff-fine-diff-A ((t (:background "#495766"))))
 `(ediff-fine-diff-Ancestor ((t (:background "#495766" :foreground ,zenburn-fg))))
 `(ediff-fine-diff-B ((t (:background "#495766" :foreground ,zenburn-fg))))
 `(ediff-fine-diff-C ((t (:background "#495766" :foreground ,zenburn-fg)))))
