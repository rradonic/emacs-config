(custom-set-faces
 ...
 '(font-lock-doc-face ((t (:foreground "#a6a6a6"))))
 '(font-lock-keyword-face ((t (:foreground "#0065d0"))))
 '(font-lock-builtin-face ((t (:foreground "#528b00"))))
 '(font-lock-string-face ((t (:foreground "#9b6252"))))
